...
Window_Base.prototype.ipColor = function(actor) {
    return this.normalColor();
};
...
Window_Base.prototype.drawActorIp = function(actor, x, y, width) {
    width = width || 96;
    var color1 = this.tpGaugeColor1();
    var color2 = this.tpGaugeColor2();
    // this.drawGauge(x, y, width, actor.ipRate, color1, color2);
    this.changeTextColor(this.systemColor());
    this.drawText(TextManager.ipA, x, y, 44);
    this.drawText(actor.ip, x + width - 64, y, 64, 'right');
};
...
Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    ...
    this.drawActorIp(actor, 0, lineHeight * 3, width2);
};
...
Window_BattleActor.prototype.actor = function() {
    var result = $gameParty.members()[this.index()];
};
